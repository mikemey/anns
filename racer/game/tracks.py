...
Earth = Level(
    name='earth 1', width=1080, height=800,
    outer_track=[500, 229, 474, 226, 450, 216, 429, 200, 413, 179, 403, 155, 383, 107, 351, 66, 310, 34, 262, 14, 210,
    ...
    outer_track_offset=3833,
    inner_track=[500, 329, 448, 322, 400, 302, 359, 270, 327, 229, 307, 181, 297, 157, 281, 136, 260, 120, 236, 110, 210,
    ...
    inner_track_offset=3245,
    single_car=TrackPosition(540, 275, 180), two_cars=(TrackPosition(545, 291, 177), TrackPosition(540, 258, 178)),
    obstacles=[TrackPosition(264, 148, -43), TrackPosition(197, 129, 8), TrackPosition(538, 457, 82),
               TrackPosition(574, 467, 66), TrackPosition(76, 763, 53)]
)

MANUAL_LEVELS = [Earth, Mercury_1, Venus]
